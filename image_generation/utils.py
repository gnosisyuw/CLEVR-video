...
def add_object(object_dir, name, scale, loc, theta=0,theta2=0):
  """
  ...
  # with open('/home/wei/PycharmProjects/stacking/output/images/save.txt', 'a+') as f:
  #   f.write(bpy.data.objects[name].name+'\n')
  #
  #   f.write(bpy.data.objects[new_name].name + '\n')

  # Set the new object as active, then rotate, scale, and translate it
  x, y = loc
  bpy.context.scene.objects.active = bpy.data.objects[new_name]
  bpy.context.object.rotation_euler[2] = theta
  bpy.context.object.rotation_euler[1] = theta2
  bpy.ops.transform.resize(value=(scale, scale, scale))
  bpy.ops.transform.translate(value=(x, y, scale))
  # return [new_name], [x,y,scale,theta]
  return new_name
